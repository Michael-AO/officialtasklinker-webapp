...
import { Upload, FileText, User, Camera, AlertCircle, Shield } from "lucide-react"
...
export function SimpleVerificationForm({ userType, onSuccess, onError }: SimpleVerificationFormProps) {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>AI-Powered Verification:</strong>
              <ul className="mt-2 space-y-1 text-sm">
                <li>• Submit your documents and information</li>
                <li>• Our advanced AI system will verify your identity</li>
                <li>• Processing typically takes 2-4 hours</li>
                <li>• You'll receive instant notification once verified</li>
              </ul>
            </AlertDescription>
          </Alert>
  ...
  return (
    <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete the form below to submit your documents for AI verification
          </CardDescription>
        </CardHeader>
