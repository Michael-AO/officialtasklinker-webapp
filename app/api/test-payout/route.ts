...
/**
 * Test payout: only when TEST_PAYOUT_KEY is set and provided (development).
 * POST body: accountNumber, accountName, bankName?, amount? (default 100 Naira)
 * Header: x-test-payout-key: <TEST_PAYOUT_KEY> or body: testPayoutKey
 */
