      ...
      <div className="space-y-6">
            ...
            <div className="space-y-4">
              {isLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">Add a bank account to start receiving withdrawals</p>
                  <Button className="mt-4" onClick={() => setShowBankAccountModal(true)}>
                    <Plus className="h-4 w-4 mr-2" />
                    Add Bank Account
                  </Button>
                </div>
        ...
        <BankAccountModal
          ...
          onClose={() => {
            ...
            fetchBankAccounts() // Refresh bank accounts after adding
          }}
        />
      </div>
    </div>
