...
import { DollarSign, Shield, CheckCircle, Clock, AlertTriangle, Eye, Download, MessageSquare } from "lucide-react"
                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {
                                    escrow.milestones.filter((m) => m.status === "completed" || m.status === "approved")
                                      .length
                                  }{" "}
