...
export default function EscrowPage() {
  ...
  const handleReleaseFunds = async (escrowId: string) => {
    if (!user?.hasPinSetup) {
      toast({
        title: "PIN Required",
        description: "Please set up your security PIN first.",
        variant: "destructive",
      })
      handlePinSetup()
      return
  ...
  const onPinVerified = async () => {
    if (selectedEscrow) {
      await releaseFunds(selectedEscrow)
      ...
      <div className="space-y-6">
        ...
        {!user?.hasPinSetup && (
          <Alert>
            ...
            <AlertDescription>
              <strong>Security PIN Required:</strong> Set up your 4-digit security PIN to manage escrow transactions,
              release funds, and make withdrawals.{" "}
        ...
        {selectedEscrow && (
          <EscrowDetailsModal
            ...
            isOpen={!!selectedEscrow && !showPinModal}
        ...
        <PinSetupModal
          ...
          mode={pinModalMode}
          onPinVerified={pinModalMode === "verify" ? onPinVerified : undefined}
        />
      </div>
    </div>
  )
